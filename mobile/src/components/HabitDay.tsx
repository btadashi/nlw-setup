...
const WEEK_DAYS = 7;
const SCREEN_HORIZONTAL_PADDING = (32 * 2) / 5; //32 de espaçamento lateral; 2 (os dois lados); 5 distância entre cada quadrado

export const DAY_MARGIN_BETWEEN = 8; // Espaçamento entre os quadrados
// Largura da tela do dispositivo dividido pelos qte dias da semana, descontado o padding horizontal
